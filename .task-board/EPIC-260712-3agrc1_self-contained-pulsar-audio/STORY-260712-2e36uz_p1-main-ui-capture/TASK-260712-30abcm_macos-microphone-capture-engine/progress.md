...
## Checklist
- [x] Implement explicit TCC-gated capture with default and selected device support
- [x] Expose bounded metering, hard limits, app-private drafts and main-program ducking
- [x] Cover cancel, device loss, permission revoke, sleep, lock where observable and quit cleanup
...
Accepted engineering head 18bae352eb76544dd13b2aa0bf646c887926c43b: CI run 29379013937 passed coordinator, 188 Swift tests on hosted macOS, portable/cross-built Windows and signed MSIX package/install/cleanup. Local release/app-bundle/plist checks also passed. PlantUML CLI was unavailable locally; the outcome source is retained as reviewable diagram code. Physical microphone and real-app observations remain exclusively in EPIC-260714-th54l3.
