...
SPEC = importlib.util.spec_from_file_location(
    "windows_encrypted_media_client_path",
    HERE / "validate_windows_encrypted_media_client_path.py",
)
...
class WindowsEncryptedMediaClientPathAcceptanceTests(unittest.TestCase):
    ...
    def test_runtime_enablement_fails_closed(self):
        ...
        with self.assertRaisesRegex(MODULE.WindowsEncryptedMediaClientPathError, "runtime"):
    ...
    def test_capability_advertisement_fails_closed(self):
        ...
        with self.assertRaisesRegex(MODULE.WindowsEncryptedMediaClientPathError, "capability"):
            MODULE.validate(changed, evidence)
    ...
    def test_implicit_history_fails_closed(self):
        ...
        with self.assertRaisesRegex(MODULE.WindowsEncryptedMediaClientPathError, "history"):
            MODULE.validate(changed, evidence)
    ...
    def test_evidence_consent_removal_fails_closed(self):
        ...
        with self.assertRaisesRegex(MODULE.WindowsEncryptedMediaClientPathError, "consent"):
            MODULE.validate(changed, evidence)
