# Encrypt and authenticate Windows live PTT end to end

## Description
Bridge Windows live sender and receiver frames to the reviewed group state without giving the coordinator plaintext.
