# Implement macOS automation administration

## Description
Add schedule principal status history and emergency disable controls to the macOS UI.
...
## Acceptance Criteria
Authorized macOS roles can understand the next fire time and skipped or repeated behavior, manage schedules and principals and stop automation quickly. Secrets are never redisplayed or persisted, unauthorized roles cannot infer configuration, VoiceOver and keyboard tests pass and disabling automation leaves manual cue and other audio paths honest.
