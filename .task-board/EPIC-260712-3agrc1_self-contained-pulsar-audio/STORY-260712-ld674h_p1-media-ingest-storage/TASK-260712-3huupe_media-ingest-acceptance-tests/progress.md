...
## Checklist
- [x] Add accepted-format and corrupt-input fixtures for the common ingest path
- [x] Cover idempotency, quota, delete, expiry and tenant ACL scenarios end to end
- [x] Map each story acceptance criterion to automated evidence or an explicit fixture
- [x] Exercise polyglot, decompression-bomb, network-protocol and worker-crash fixtures
- [x] Exercise concurrent resume, stale worker, delete and cleanup-restart races
