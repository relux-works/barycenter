...
var templates = map[string]textPair{
	...
	"stream_track.draft.retained":                {"Ready to upload", "Готово к загрузке"},
	"stream_track.draft.uploading":               {"Uploading", "Загрузка"},
	"stream_track.draft.uploaded":                {"Upload confirmed", "Загрузка подтверждена"},
	"stream_track.draft.processing":              {"Processing audio", "Обработка аудио"},
	"stream_track.draft.ready":                   {"Track ready", "Трек готов"},
	"stream_track.draft.failed":                  {"Track preparation failed", "Не удалось подготовить трек"},
	"stream_track.playback.idle":                 {"Not playing", "Не воспроизводится"},
	"stream_track.playback.queued":               {"Queued", "В очереди"},
	"stream_track.playback.loading":              {"Buffering", "Буферизация"},
	"stream_track.playback.ready":                {"Ready to play", "Готово к воспроизведению"},
	"stream_track.playback.playing":              {"Playing", "Воспроизводится"},
	"stream_track.playback.paused":               {"Paused", "На паузе"},
	"stream_track.playback.seeking":              {"Seeking", "Переход к позиции"},
	"stream_track.playback.rebuffering":          {"Rebuffering", "Повторная буферизация"},
	"stream_track.playback.ended":                {"Played", "Воспроизведено"},
	"stream_track.playback.failed":               {"Playback failed", "Ошибка воспроизведения"},
	"stream_track.action.accept_policy":          {"Review and accept", "Ознакомиться и принять"},
	"stream_track.action.upload":                 {"Upload track", "Загрузить трек"},
	"stream_track.action.retry":                  {"Try again", "Повторить"},
	"stream_track.action.delete":                 {"Delete", "Удалить"},
	"stream_track.action.queue":                  {"Add to queue", "Добавить в очередь"},
	"stream_track.action.replace":                {"Replace current", "Заменить текущий"},
	"stream_track.action.pause":                  {"Pause", "Пауза"},
	"stream_track.action.seek":                   {"Seek", "Перейти"},
	"stream_track.action.resume":                 {"Resume", "Продолжить"},
	"stream_track.action.report":                 {"Report", "Пожаловаться"},
	"stream_track.failure.offline":               {"Offline. Your draft is kept on this device.", "Нет сети. Черновик сохранён на этом устройстве."},
	"stream_track.failure.quota_exceeded":        {"Storage or transfer limit reached", "Достигнут лимит хранения или передачи"},
	"stream_track.failure.unsupported_targets":   {"Some recipients cannot play tracks", "Некоторые получатели не могут воспроизводить треки"},
	"stream_track.failure.policy_required":       {"Accept the current content policy first", "Сначала примите текущие правила содержимого"},
	"stream_track.failure.processing_failed":     {"Audio processing failed", "Не удалось обработать аудио"},
	"stream_track.failure.variant_unavailable":   {"No supported playback variant is available", "Нет поддерживаемого варианта воспроизведения"},
	"stream_track.failure.stale_generation":      {"Playback changed; refresh the controls", "Воспроизведение изменилось; обновите управление"},
	"stream_track.failure.service_unavailable":   {"Service unavailable. Try again later.", "Сервис недоступен. Повторите позже."},
}
